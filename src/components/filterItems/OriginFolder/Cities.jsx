  ...
  return (
    <>
      ...
      >
        ...
        <p className="pb-4 border-b border-default-300 flex-1 text-start text-default-700">
      ...
      <label className="label cursor-pointer gap-4 justify-start p-0">
        ...
        />
        <span class="flex-1 label-text text-base font-semibold text-default-700 py-4 border-b border-default-300">
